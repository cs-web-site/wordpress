 ...
 * @since 1.0.0
 */
class X_Corporate_Heading_Control extends WP_Customize_Control {
 ...
 * @since 1.0.0
 */
class X_Corporate_Message_Control extends WP_Customize_Control {
 ...
 */
class X_Corporate_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'x-corporate' );
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'x-corporate-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class X_Corporate_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class X_Corporate_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'x-corporate-customize-controls' );
		wp_enqueue_style( 'x-corporate-customize-controls' );
 ...
 * @access public
 */
class X_Corporate_Upsell_Section extends WP_Customize_Section {
