...
if ( ! class_exists( 'X_Corporate_Widget_Helper' ) ) {
	 ...
	 * @version 2.0.2
	 */
	class X_Corporate_Widget_Helper extends WP_Widget {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					<div class="widget-field-image">
						<label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html( $field['label'] ); ?></label>
						<input type="button" class="button button-primary wh-image-picker" value="<?php esc_attr_e( 'Upload', 'x-corporate' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'x-corporate' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'x-corporate' ); ?>" />
						...
						<input type="button" class="button button-secondary btn-image-remove" value="<?php esc_attr_e( 'Remove', 'x-corporate' ); ?>" <?php echo ( empty( $value ) ) ? 'style="display:none;"' : ''; ?> />
